...
int mult_stone(char *nbL, unsigned int ulnbL, char *nbR, unsigned int uLnbR)
{
    ...
    int SavenbR = 0;
    int keep = 0;
    char *result = memory3(lnbL + LnbR + 2);
